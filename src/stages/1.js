    ...
    if (message === '1') {
      ...
      Object.keys(menu).map((value) => {
        ...
        if (value === '1') {
          ...
          msg += `6️⃣ - _${element.description}_ \n`;
        } else if (value === '7') {
          msg += `7️⃣ - _${element.description}_ \n`;
        } else if (value === '8') {
          msg += `8️⃣ - _${element.description}_ \n`;
        } else if (value === '9') {
          msg += `9️⃣ - _${element.description}_ \n`;
        } else if (value === '10') {
          msg += `🔟 - _${element.description}_ \n`;
        } else if (value === '11') {
          msg += `1️⃣1️⃣ - _${element.description}_ \n`;
        } else if (value === '12') {
          msg += `1️⃣2️⃣ - _${element.description}_ \n`;
        } else if (value === '13') {
          msg += `1️⃣3️⃣ - _${element.description}_ \n`;
        }
      });
